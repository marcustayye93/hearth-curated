...
export const PRODUCTS: Product[] = [
  ...
  {
    id: "adorn-17",
    slug: "nordic-waffle-throw-blanket",
    name: "Nordic Waffle Throw Blanket",
    headline: "The Quiet Layer",
    hookLine: "A chunky waffle-knit throw with tassel fringe — for the sofa, the bed, or wherever you land.",
    description:
      "A chunky knit throw blanket with a distinctive waffle embossed texture and decorative tassel fringe along both ends. The kind of blanket that transforms any seat into the best seat in the house — draped over a sofa arm, folded at the foot of a bed, or wrapped around your shoulders on a cool evening. The waffle weave creates natural air pockets that regulate temperature beautifully, keeping you warm without overheating. The neutral ivory tone works with virtually any interior palette, and the generous dimensions (130×170cm) provide genuine coverage rather than decorative suggestion.",
    price: 58.00,
    collection: "ADORN",
    collectionSlug: "adorn",
    image: "https://d2xsxph8kpxj0f.cloudfront.net/310519663320869327/ATXAQqZMviwYB4q65RwV96/nordic-knit-throw-blanket-bYUGYhmGZFqNMokDTCgysP.webp",
    tags: ["blanket", "throw", "knit", "waffle", "nordic", "tassel", "cozy"],
    notes: "Knit acrylic blend · Waffle texture · Tassel fringe · 130×170cm",
    available: true,
    crossSells: ["adorn-8", "adorn-13", "adorn-5"],
  },
  ...
  // ── NEW GATHER EXPANSION (Matcha, Ceramics, Acacia) ─────────────────
  {
    id: "gather-14",
    ...
    description:
      "A complete matcha ceremony set in six pieces — everything you need to transform a morning cup of green tea into a meditative ritual. The bamboo chasen (whisk) has 80 fine tines for a perfect froth, the ceramic chawan (bowl) has a smooth matte finish and pouring spout, and the bamboo scoop and spoon are carved from a single piece. The set includes a ceramic whisk holder to preserve the chasen's shape between uses, and a fine-mesh sieve for clump-free matcha every time.",
    price: 52.0,
    collection: "GATHER",
    collectionSlug: "gather",
    ...
    available: true,
    crossSells: ["gather-15", "gather-16", "gather-5"],
  },
  {
    id: "gather-15",
    slug: "bamboo-matcha-whisk",
    name: "Bamboo Matcha Whisk",
    headline: "Eighty Tines of Tradition",
    hookLine: "A hand-carved bamboo chasen — the tool that turns powder into ceremony.",
    description:
      "A hand-carved bamboo matcha whisk with 80 fine tines — the traditional chasen that has been the centrepiece of Japanese tea ceremony for centuries. The natural bamboo is lightweight, flexible, and shaped to create a perfect froth when whisked in a W-motion across the surface of your matcha. Each whisk is carved from a single piece of bamboo, making every one subtly unique. Comes in a protective clear tube for storage and gifting.",
    price: 18.0,
    collection: "GATHER",
    collectionSlug: "gather",
    image: "https://d2xsxph8kpxj0f.cloudfront.net/310519663320869327/ATXAQqZMviwYB4q65RwV96/bamboo-matcha-whisk-cDPaBQDpw4a56oVt7ZGrXw.webp",
    tags: ["matcha", "whisk", "chasen", "bamboo", "tea", "japanese"],
    notes: "80 tines · Hand-carved bamboo · Protective tube included",
    available: true,
    crossSells: ["gather-14", "gather-16", "gather-5"],
  },
  {
    id: "gather-16",
    slug: "ceramic-matcha-bowl",
    name: "Ceramic Matcha Bowl",
    headline: "The Vessel for Stillness",
    hookLine: "A smooth matte ceramic bowl with a pouring spout — for matcha, for tea, for pause.",
    description:
      "A ceramic matcha bowl with a smooth matte finish and a subtle pouring spout — the kind of vessel that makes you slow down before your first sip. The wide, shallow shape is designed for whisking matcha with a chasen, but it works equally well as a small soup bowl, a dipping sauce vessel, or a place to hold rings and small objects on a bedside table. The matte cream glaze has a tactile, stone-like quality that warms in the hand.",
    price: 22.0,
    collection: "GATHER",
    collectionSlug: "gather",
    image: "https://d2xsxph8kpxj0f.cloudfront.net/310519663320869327/ATXAQqZMviwYB4q65RwV96/ceramic-matcha-bowl-Wyet5NnyV4ZABtDsAzMKui.webp",
    tags: ["matcha", "bowl", "chawan", "ceramic", "matte", "japanese", "tea"],
    notes: "Matte ceramic · Pouring spout · Approx. 11cm diameter × 7cm tall",
    available: true,
    variants: [
      { id: "gather-16-cream", label: "Cream", price: 22.0, available: true },
      { id: "gather-16-sage", label: "Sage Green", price: 22.0, available: true },
      { id: "gather-16-char", label: "Charcoal", price: 22.0, available: true },
    ],
    crossSells: ["gather-14", "gather-15", "gather-5"],
  },
  {
    id: "gather-17",
    slug: "handmade-stoneware-espresso-cup",
    name: "Handmade Stoneware Espresso Cup",
    headline: "The First Sip",
    hookLine: "A handmade stoneware cup in earth tones — for espresso, cortado, or matcha shots.",
    description:
      "A handmade stoneware espresso cup with a reactive glaze that creates unique earth-tone patterns on every piece — no two cups are exactly alike. The thick walls retain heat beautifully, keeping your espresso or cortado warm through the last sip. The slightly irregular rim and organic shape give it the feel of something made by hand in a ceramicist's studio, not a factory. Holds approximately 100ml.",
    price: 16.0,
    collection: "GATHER",
    collectionSlug: "gather",
    image: "https://d2xsxph8kpxj0f.cloudfront.net/310519663320869327/ATXAQqZMviwYB4q65RwV96/stoneware-espresso-cup-Xi4NhKZerxYEk2WY7efybW.webp",
    tags: ["espresso", "cup", "stoneware", "handmade", "ceramic", "coffee"],
    notes: "Handmade stoneware · Reactive glaze · ~100ml capacity",
    available: true,
    variants: [
      { id: "gather-17-brown", label: "Earth Brown", price: 16.0, available: true },
      { id: "gather-17-green", label: "Moss Green", price: 16.0, available: true },
      { id: "gather-17-grey", label: "Ash Grey", price: 16.0, available: true },
      { id: "gather-17-sand", label: "Sand", price: 16.0, available: true },
    ],
    crossSells: ["gather-18", "gather-16", "gather-5"],
  },
  {
    id: "gather-18",
    slug: "vintage-stoneware-coffee-mug",
    name: "Vintage Stoneware Coffee Mug",
    headline: "The Morning Companion",
    hookLine: "A generous stoneware mug with vintage kiln-fired glaze — for the long morning cup.",
    description:
      "A generous stoneware coffee mug with a vintage kiln-fired glaze — the kind of mug that becomes your default, the one you reach for every morning without thinking. The thick handle sits comfortably in the hand, and the weighted base prevents tipping. Each mug has unique glaze variations from the kiln firing process.",
    price: 26.0,
    collection: "GATHER",
    collectionSlug: "gather",
    image: "https://d2xsxph8kpxj0f.cloudfront.net/310519663320869327/ATXAQqZMviwYB4q65RwV96/vintage-stoneware-mug-KFDxKcCWo2f5iNjtPypLsg.webp",
    tags: ["mug", "coffee", "stoneware", "vintage", "kiln", "ceramic"],
    notes: "Stoneware · Kiln-fired glaze · Microwave & dishwasher safe",
    available: true,
    variants: [
      { id: "gather-18-esp", label: "100ml / Espresso", price: 16.0, available: true },
      { id: "gather-18-cort", label: "180ml / Cortado", price: 22.0, available: true },
      { id: "gather-18-long", label: "230ml / Long Coffee", price: 26.0, available: true },
    ],
    crossSells: ["gather-17", "gather-14", "gather-5"],
  },
  {
    id: "gather-19",
    slug: "round-acacia-plate-small",
    name: "Round Acacia Serving Plate — 20cm",
    headline: "The Everyday Surface",
    hookLine: "A 20cm round acacia plate — for cheese, for bread, for the small rituals of the table.",
    description:
      "A 20cm round serving plate carved from a single piece of acacia wood — the kind of surface that makes even a simple piece of cheese and a few crackers feel like an occasion. The natural grain patterns are unique to each plate, and the shallow lip keeps crumbs and oils contained without looking like a traditional plate. Stackable for easy storage.",
    price: 22.0,
    collection: "GATHER",
    collectionSlug: "gather",
    image: "https://d2xsxph8kpxj0f.cloudfront.net/310519663320869327/ATXAQqZMviwYB4q65RwV96/acacia-plate-small-kEBtEPCexBq7saeh5dXkfK.webp",
    tags: ["plate", "acacia", "wood", "serving", "round", "cheese", "bread"],
    notes: "Acacia wood · 20cm diameter · Food-safe finish · Stackable",
    available: true,
    crossSells: ["gather-20", "gather-21", "gather-2"],
  },
  {
    id: "gather-20",
    slug: "round-acacia-plate-large",
    name: "Round Acacia Serving Plate — 25cm",
    headline: "The Generous Surface",
    hookLine: "A 25cm round acacia plate — for sharing, for styling, for the centre of the table.",
    description:
      "A 25cm round serving plate in acacia wood — generous enough for a cheese board, a stack of pancakes, or a styled arrangement of fruit. The larger surface area makes it a natural centrepiece for a dining table or kitchen island. Like its smaller sibling, each plate has unique grain patterns from the natural wood, and the food-safe finish deepens in colour with use and oiling.",
    price: 28.0,
    collection: "GATHER",
    collectionSlug: "gather",
    image: "https://d2xsxph8kpxj0f.cloudfront.net/310519663320869327/ATXAQqZMviwYB4q65RwV96/acacia-plate-large-Trj8g8rmt8ttNcygxGD9eT.webp",
    tags: ["plate", "acacia", "wood", "serving", "round", "sharing", "centrepiece"],
    notes: "Acacia wood · 25cm diameter · Food-safe finish · Stackable",
    available: true,
    crossSells: ["gather-19", "gather-21", "gather-2"],
  },
  {
    id: "gather-21",
    slug: "acacia-snack-board",
    name: "Acacia Wood Snack Board",
    headline: "The Organised Spread",
    hookLine: "An acacia board with carved compartments — for nuts, dried fruit, and considered snacking.",
    description:
      "An acacia wood snack board with carved compartments — designed for the kind of considered snacking that turns an afternoon break into a small event. The divided sections keep nuts, dried fruit, olives, and cheese neatly separated, while the natural wood grain gives the whole arrangement a warm, organic quality. The board doubles as a charcuterie platter for entertaining, or a breakfast tray for weekend mornings.",
    price: 35.0,
    collection: "GATHER",
    collectionSlug: "gather",
    ...
    tags: ["snack", "board", "acacia", "wood", "compartments", "charcuterie", "entertaining"],
    notes: "Acacia wood · Multiple compartments · Food-safe finish · Approx. 28cm diameter",
    available: true,
    crossSells: ["gather-19", "gather-20", "gather-2"],
  },

  // ── NEW AUTODS PRODUCTS (March 28, 2026) ──────────────────────────
  {
    id: "gather-22",
    slug: "natural-wooden-fruit-bowl",
    name: "Natural Wooden Fruit Bowl",
    headline: "The Honest Vessel",
    hookLine: "A hand-finished wooden bowl for fruit, salad, or simply being beautiful.",
    description:
      "A natural wooden bowl with the kind of quiet presence that makes you want to fill it with something beautiful — or leave it empty and let the grain speak for itself. Hand-finished from a single piece of solid wood, each bowl carries unique variations in colour and pattern that no factory could replicate. The generous proportions make it equally suited to a family salad, a pile of seasonal fruit, or a centrepiece arrangement. The smooth interior and gently curved rim give it a tactile quality that improves with every use.",
    price: 38.00,
    collection: "GATHER",
    collectionSlug: "gather",
    ...
    tags: ["bowl", "wood", "natural", "fruit", "salad", "kitchen"],
    notes: "Natural wood · Hand-finished · Multiple sizes available",
    available: true,
    variants: [
      { id: "gather-22-s", label: "Small (15×7cm)", price: 22.00, available: true },
      { id: "gather-22-m", label: "Medium (20×8cm)", price: 32.00, available: true },
      { id: "gather-22-l", label: "Large (25×10cm)", price: 38.00, available: true },
      { id: "gather-22-xl", label: "Extra Large (30×10cm)", price: 48.00, available: true },
    ],
    crossSells: ["gather-2", "gather-20", "gather-21"],
  },
  {
    id: "gather-23",
    slug: "ceramic-side-dish-plates",
    name: "Ceramic Side Dish Plates",
    headline: "Small Plates, Big Character",
    hookLine: "Organic-edge ceramic plates for banchan, mezze, or anything worth savouring slowly.",
    description:
      "A set of ceramic side dish plates with gently irregular edges and a matte glaze that catches the light in unexpected ways. Designed for the kind of dining where every condiment, pickle, and side dish gets its own stage — banchan, mezze, tapas, or simply a more considered way to serve dinner. The shallow depth keeps food visible and accessible, while the organic shape gives each plate the character of something made by hand. Available in muted earth tones that mix beautifully together.",
    price: 28.00,
    collection: "GATHER",
    collectionSlug: "gather",
    image: "https://d2xsxph8kpxj0f.cloudfront.net/310519663320869327/ATXAQqZMviwYB4q65RwV96/ceramic-serving-dishes-EHJTKJdVMrzKVkefnNAMd8.webp",
    tags: ["plates", "ceramic", "side dish", "serving", "banchan", "mezze"],
    notes: "Ceramic · Matte glaze · Dishwasher safe · Multiple colours",
    available: true,
    variants: [
      { id: "gather-23-sage", label: "Sage Green", price: 28.00, available: true },
      { id: "gather-23-cream", label: "Cream White", price: 28.00, available: true },
      { id: "gather-23-terra", label: "Terracotta", price: 28.00, available: true },
    ],
    crossSells: ["gather-24", "gather-22", "gather-3"],
  },
  {
    id: "gather-24",
    slug: "retro-stoneware-set",
    name: "Retro Stoneware Bowls & Plates",
    headline: "The Collected Table",
    hookLine: "Reactive-glaze stoneware in deep teal and cream — each piece uniquely fired.",
    description:
      "A collection of stoneware bowls and plates finished in a reactive glaze that creates beautiful, unrepeatable colour variations in deep teal, rust, and speckled cream. The kind of tableware that looks like it was collected over years of travel — except you can have the whole set at once. Each piece is kiln-fired at high temperature for exceptional durability, and the slightly irregular rims give them the warmth of handmade ceramics. Stack them on open shelves or mix them into your existing tableware for an effortlessly curated look.",
    price: 32.00,
    collection: "GATHER",
    collectionSlug: "gather",
    image: "https://d2xsxph8kpxj0f.cloudfront.net/310519663320869327/ATXAQqZMviwYB4q65RwV96/retro-bowls-plates-VhXtW9wvwgUJQ9Way7J7Qu.webp",
    tags: ["bowls", "plates", "stoneware", "retro", "reactive glaze", "ceramic"],
    notes: "Stoneware · Reactive glaze · Dishwasher & microwave safe",
    available: true,
    variants: [
      { id: "gather-24-bowl-s", label: "Bowl — Small", price: 18.00, available: true },
      { id: "gather-24-bowl-l", label: "Bowl — Large", price: 24.00, available: true },
      { id: "gather-24-plate-s", label: "Plate — Small", price: 22.00, available: true },
      { id: "gather-24-plate-l", label: "Plate — Large", price: 32.00, available: true },
    ],
    crossSells: ["gather-23", "gather-22", "gather-7"],
  },
  {
    id: "gather-25",
    slug: "matcha-ceremony-bowl-whisk",
    name: "Matcha Ceremony Set — Bowl & Whisk",
    headline: "The Morning Ritual",
    hookLine: "A ceramic chawan and bamboo chasen — everything you need for a proper matcha practice.",
    description:
      "A complete matcha ceremony set featuring a wide ceramic bowl (chawan) with a beautiful speckled sage glaze and a traditional bamboo whisk (chasen) with fine tines designed to create the perfect froth. The set includes a bamboo scoop (chashaku) for measuring the ideal amount of matcha powder. This is not a shortcut to matcha — it is an invitation to slow down, to pay attention to the water temperature, the whisking motion, and the moment of quiet before the first sip. The bowl's wide base and low centre of gravity make it stable during whisking, while the interior glaze develops a beautiful patina over time.",
    price: 42.00,
    collection: "GATHER",
    collectionSlug: "gather",
    image: "https://d2xsxph8kpxj0f.cloudfront.net/310519663320869327/ATXAQqZMviwYB4q65RwV96/matcha-tea-set-bowl-brush-nFBjVbLeCc2vFZ2Upwuidi.webp",
    tags: ["matcha", "tea", "ceremony", "bowl", "whisk", "japanese", "bamboo"],
    notes: "Ceramic bowl + bamboo whisk + bamboo scoop · Multiple glaze options",
    available: true,
    variants: [
      { id: "gather-25-sage", label: "Sage Green", price: 42.00, available: true },
      { id: "gather-25-ivory", label: "Ivory White", price: 42.00, available: true },
      { id: "gather-25-charcoal", label: "Charcoal", price: 42.00, available: true },
      { id: "gather-25-blush", label: "Blush Pink", price: 42.00, available: true },
    ],
    crossSells: ["gather-14", "gather-15", "gather-16"],
  },
];
